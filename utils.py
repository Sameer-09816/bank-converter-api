...
def generate_random_credentials():
    ...
    Includes a millisecond timestamp in the username to guarantee uniqueness.
    """
...
def extract_verification_link_from_html(html_content):
    """
    Uses BeautifulSoup to safely and reliably parse the HTML email content
    and find the verification link.
    """
    try:
